...
public enum L10n {
    ...
    public static var titlePlaceholder: String {
        String(localized: "title.placeholder", defaultValue: "What feature would you like to see?", bundle: .module)
    }
    ...
    public static var loadingError: String {
        String(localized: "loading.error", defaultValue: "Failed to load feature requests", bundle: .module)
    }
