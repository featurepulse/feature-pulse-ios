...
- **Restriction alerts** - Subscription names are now inserted correctly in localized messages
...
```swift
.package(url: "https://github.com/featurepulse/feature-pulse-ios.git", from: "1.12.0")
```
...
- **iOS 16 support** — minimum deployment target lowered from iOS 17 to iOS 16

### 📦 Installation

```swift
.package(url: "https://github.com/featurepulse/feature-pulse-ios.git", from: "1.11.0")
```
...
- **Demo project** — new Demo app included in the repository showcasing SDK integration
- **Test coverage** — unit and integration tests added for core SDK components

### 📦 Installation

```swift
.package(url: "https://github.com/featurepulse/feature-pulse-ios.git", from: "1.10.5")
```
...
- **Close button** - Fixed close button placement in the CTA banner

### 📦 Installation

```swift
.package(url: "https://github.com/featurepulse/feature-pulse-ios.git", from: "1.10.3")
```
